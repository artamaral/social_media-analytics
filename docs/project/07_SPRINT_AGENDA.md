...
- a primeira rodada Batch 1 com transcricao real gravou `2/10` videos e falhou
  ...
  YouTube
- a versao `2026-07-30-r17-audio-first-fallback` introduziu o caminho estavel
  para baixar a fonte sem conversao pelo `yt-dlp`, preferindo audio leve
  `139/140` antes do progressivo `18`, e cortar/converter em etapa separada
...
- com `android_vr + WARP SOCKS5 + cookies`, os quatro pendentes do Batch 2
  rodaram sem falhas; caminho estavel de audio ficou em `1.45s..4.27s`, Whisper em
  `9.64s..22.40s` e OpenAI em `46.60s..70.16s`
- o Batch 2 fechou `10/10` no Supabase, todos com
  `transcript_quality_status = usable`
- em 2026-07-31, os logs do Batch 1 mostraram que o caminho chamado de
  fallback era, na pratica, o caminho estavel; o classificador foi ajustado para
  tentar primeiro a fonte leve `139/140/18` sem conversao pelo `yt-dlp`,
