...
- [ ] [analise] ATIVIDADE ATUAL E PRIORITARIA: iniciar os itens 19 e 20 da fase 2 Fenabrave, cobrindo `Modelos mais emplacados venda direta mes` na pagina 30 e `Modelos mais emplacados venda varejo mes` na pagina 31, depois de concluir os itens 13 a 18 com parser posicional, preview no Streamlit, persistencia em `market_vehicle_brand_rankings` para rankings por share e backfill historico validado para `12/2025` a `06/2026`.
