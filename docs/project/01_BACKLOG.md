...
- [ ] [analise] ATIVIDADE ATUAL E PRIORITARIA: iniciar os itens 21 e 22 da fase 2 Fenabrave, cobrindo `Modelos mais emplacados venda direta acumulado` na pagina 32 e `Modelos mais emplacados venda varejo acumulado` na pagina 33, reaproveitando o contrato dos itens 19 e 20 em `market_vehicle_model_rankings` e validando o comparativo mensal versus acumulado no historico de `12/2025` a `06/2026`.
