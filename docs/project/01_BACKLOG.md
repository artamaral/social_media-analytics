...
- [x] Implementar coleta historica de followers de creators do YouTube. Implementado no `youtube_main_scraper` com `channels.list(part=contentDetails,statistics)`, snapshots em `creator_metrics_history`, sincronizacao por trigger em `creators` e validacao ponta a ponta em 2026-05-22.
