...
- [ ] [analise] ATIVIDADE ATUAL E PRIORITARIA: concluir os itens 15 e 16 da fase 2 Fenabrave, cobrindo os rankings por marca de venda direta nas paginas 28 e 29, depois de finalizar os itens 13 e 14 com parser posicional, preview no Streamlit, persistencia em `market_vehicle_brand_rankings` e backfill historico validado para `12/2025` a `06/2026`; na sequencia imediata, preparar os novos itens 17 e 18 das paginas 3 e 4 como consolidado de participacao de mercado por marca.
